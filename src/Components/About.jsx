...
export default function About(){
    ...
    className='font-bold lg:text-6xl flex justify-center items-center lg:gap-5 gap-2 mb-10 text-3xl'>
        About
    <div>
    ...
    className='border-2 border-slate-200 py-10 lg:p-10 rounded-2xl lg:py-32 shadow-lg lg:shadow-xl lg:shadow-slate-400 shadow-slate-400'>
    <div className='lg:flex lg:flex-row lg:justify-around lg:items-center flex flex-col justify-center items-center  gap-7'>
        ...
        <div className='lg:w-[50%] lg:text-3xl text-sm font cursor-context-menu w-[74%]'>
        <p>
