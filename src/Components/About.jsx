...
export default function About(){
    ...
    className='font-bold text-6xl flex justify-center items-end gap-5 mb-10'>
        About
    <div>
    ...
    className='border-2 border-slate-200 py-16 lg:p-10 rounded-2xl lg:py-32 shadow-lg lg:shadow-xl lg:shadow-slate-400 shadow-slate-400'>
